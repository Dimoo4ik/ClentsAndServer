...
public class FileCopySimpleExample {
    public static void main(String[] args) {
        Path inputPath = Path.of("C:\\Users\\Minos_qg35\\IdeaProjects\\ClentsAndServer\\src\\main\\java\\file_copy_example\\input.txt");
        Path outputPath = Path.of("C:\\Users\\Minos_qg35\\IdeaProjects\\ClentsAndServer\\src\\main\\java\\file_copy_example\\output.txt");
